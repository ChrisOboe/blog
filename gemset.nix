{
  ...
  google-protobuf = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "00qkkn1bc5828anq13s9zma2lk24m7gl1hs8c778ppar3yiv4a94";
      type = "gem";
    };
    version = "4.26.0.rc.2";
  };
  ...
  httpx = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "01qyjx3wgm3v9hsq1vrngx8v0f00b2khvwv6y20s34ab7x1871h0";
      type = "gem";
    };
    version = "1.2.2";
  };
  ...
  jekyll-kroki = {
    dependencies = ["faraday" "faraday-retry" "httpx" "jekyll" "nokogiri"];
